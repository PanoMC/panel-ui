...
export function collectLicenses(outputDir = null) {
  ...
  for (const [packageName, version] of Object.entries(allDependencies)) {
    ...
    licenses.push({
      ...
      homepage: homepage,
      author: pkg.author ? (typeof pkg.author === 'string' ? pkg.author : pkg.author.name) : null,
    });
  }
  ...
  console.log(
    `✅ ${licenses.length} paketin lisans bilgisi toplandı ve ${outputPath} dosyasına kaydedildi.`,
  );
}
