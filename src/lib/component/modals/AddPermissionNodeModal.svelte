      ...
      <div class="modal-content">
          ...
          <div class="mb-3">
            <div class="input-group">
              <input
                ...
                placeholder={$_(
                  "components.modals.add-permission-node.input-placeholder",
                )}
          ...
          {#if selectedPermissions.length > 0}
            <div class="mb-3">
              <p class="mb-2 fw-bold">
                {$_(
                  "components.modals.add-permission-node.selected-permissions-label",
                )}
              </p>
              <div
                class="d-flex flex-wrap gap-2"
                aria-label="Selected permissions list">
          ...
          <div class="mb-3">
            ...
            <div
              ...
              <label class="btn btn-outline-primary" for="expiry-never"
                >{$_(
                  "components.modals.add-permission-node.expiry-never",
                )}</label>
              ...
              <label class="btn btn-outline-primary" for="expiry-date"
                >{$_(
                  "components.modals.add-permission-node.expiry-date",
                )}</label>
            </div>
            {#if expiryType === "date"}
              <input
        ...
        <div class="modal-footer">
          <button
            ...
            {$_(
              "components.modals.add-permission-node.add-permissions-button",
              {
