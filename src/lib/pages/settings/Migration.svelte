    ...
    <ul class="nav nav-tabs border-bottom-0" id="migrateTabs" role="tablist">
      <li class="nav-item" role="presentation">
        <button
          ...
          id="azuriom-tab"
          data-bs-toggle="tab"
          data-bs-target="#azuriom"
          type="button"
          role="tab"
          aria-controls="azuriom"
          aria-selected="true">
          Azuriom
        </button>
      </li>
      <li class="nav-item" role="presentation">
        <button
          ...
          id="namelessmc-tab"
          data-bs-toggle="tab"
          data-bs-target="#namelessmc"
          type="button"
          role="tab"
          aria-controls="namelessmc"
          aria-selected="false">
          NamelessMC
        </button>
      </li>
      <li class="nav-item" role="presentation">
        <button
          ...
          id="leaderos-tab"
          data-bs-toggle="tab"
          data-bs-target="#leaderos"
          type="button"
          role="tab"
          aria-controls="leaderos"
          aria-selected="true">
          LeaderOS
        </button>
      </li>
      <li class="nav-item" role="presentation">
        <button
          ...
          id="minexon-tab"
          data-bs-toggle="tab"
          data-bs-target="#minexon"
          type="button"
          role="tab"
          aria-controls="minexon"
          aria-selected="false">
          Minexon
        </button>
      </li>
